...
class AddPermissionsFromMiddleware extends Command
{
    protected $signature = 'permission:add-from-middleware';
    protected $description = 'Add permissions based on can:* middleware inside all controllers';
